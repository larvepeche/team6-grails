...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'lamba.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'lamba.UserRole'
grails.plugin.springsecurity.authority.className = 'lamba.Role'
